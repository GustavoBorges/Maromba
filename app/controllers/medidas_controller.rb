class MedidasController < ApplicationController
  ...
  private
    ...
    def medida_params
      params.require(:medida).permit(:ombro, :torax, :braco_esquerdo, :braco_direito, :panturrilha_esquerda, :panturrilha_direita, :abdomem, :cintura, :quadril, :coxa_esquerda, :coxa_direita)
    end
end
